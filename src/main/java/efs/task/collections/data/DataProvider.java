...
public class DataProvider {
    ...
    public List<Town> getTownsList() {
        ...
        for (var town : Data.baseTownsArray) {
            ...
            List<String> list_of_classes = List.of(class_one, class_two);
    ...
    public Set<Hero> getHeroesSet() {
        ...
        for (String data_of_hero : Data.baseCharactersArray) {
            String[] data_of_hero_arr = data_of_hero.split(DATA_SEPARATOR);
            if (data_of_hero_arr.length == 2) {
                String name_of_hero = data_of_hero_arr[0].trim();
                String class_of_hero = data_of_hero_arr[1].trim();
